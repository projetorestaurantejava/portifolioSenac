...
public class Paineis {
    ...
    public static JPanel painelBorderLayout(int x, int y, int largura, int altura, Color cor, JFrame frame){
        JPanel painel = new JPanel();
        frame.add(painel);
    ...
    public static JPanel painel(int x, int y, int largura, int altura, JScrollPane scroll){
        JPanel painel = new JPanel();
        painel.setLayout(null);
        painel.setBounds(x, y, largura, altura);
